...
class VerificationTestCases(lsst.utils.tests.TestCase):
    ...
    def test_biasVerify(self):
        ...
        self.genericComparison('ci_cpv_bias', dataId, mapping, delta=5.0)
    ...
    def test_darkVerify(self):
        ...
        self.genericComparison('ci_cpv_dark', dataId, mapping, delta=5.0)
    ...
    def test_flatVerify(self):
        ...
        self.genericComparison('ci_cpv_flat', dataId, mapping, delta=5.0)
